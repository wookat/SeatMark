...
export const styleSeriesTemplates: LabelTemplate[] = [
  ...
  },
  {
    ...
    name: '黑白系·考场座签',
    category: 'exam',
    description: '60×32 mm 一页 24 枚，右侧黑块反白座位号，左侧姓名与信息列。只用黑白两色，普通激光打印机也能印得干净利落。',
    scenario: '极简风考场座签',
    accent: '#111827',
  ...
  },
  {
    ...
    name: '深蓝系·参会胸牌',
    category: 'event',
    description: '90×55 mm 胸牌，藏青顶带下一道金线分隔，姓名大字居中，单位与职务两行居下。可装别针卡套，也可穿挂绳。',
    scenario: '商务深蓝参会证',
    accent: '#1e3a5f',
  ...
  },
  {
    ...
    name: '红金系·喜宴桌号牌',
    category: 'wedding',
    description: '140×90 mm 桌号牌，朱红底纹配对角祥云线，桌号用金色大字居中。中式婚宴、寿宴厅内隔着几桌也能看清。',
    scenario: '中式喜宴桌号牌',
    accent: '#9f1239',
  ...
  // ================= 复古证书系列 =================
  {
    ...
    name: '复古系·颁奖席签',
    category: 'event',
    description: '180×90 mm 席签，米色底双线花框配桂枝角饰，获奖人姓名大字居上，奖项名居下。颁奖典礼主席台与获奖席各放一张。',
    scenario: '复古证书风颁奖席',
    accent: '#8a6d3b',
