...
export const labelPapers: LabelPaperSpec[] = [
  ...
  {
    slug: 'a4-8up-spine',
    name: 'A4 8格竖条不干胶（40×120，4 列 × 2 行）',
    aliases: ['档案盒脊背标签纸', 'A4 竖条标签', '40×120 标签'],
    cols: 4,
    rows: 2,
    labelWidth: 40,
    labelHeight: 120,
    ...
    gapY: 8,
    corner: 'square',
    description: '40×120 mm 竖长条分切，一页 8 枚，档案盒脊背、文件盒侧标与竖版书脊贴专用。',
    uses: ['档案盒脊背标签', '文件盒侧标', '竖版书脊贴'],
    recommendedTemplates: ['archiveBoxSpine', 'bookLabel', 'assetTag'],
  },
  {
    slug: 'a4-10up',
