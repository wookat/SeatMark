...
export const NOVEL_STYLE_NAMES: readonly string[] = [
  '苏沐宸', '闻人静姝', '霍云峥', '容景行', '沈疏影', '钟无衍', '路远歌', '許長安',
  '闻人靖', '穆清和', '任星野', '柏语汐', '欧阳文瑾', '楚天阔', '沈鹤龄', '姜暮云',
  '安芷若', '桑云野', '路远舟', '苏浅语', '沈知微', '赵与澜', '秦书悦', '林听澜',
  '沈知遥', '顾砚秋', '费临舟', '宁远舟', '祁明萱', '陆呈之', '安若飞', '江晓白',
  '柏景行', '尹初晴', '阮青栀', '温良玉', '康书禾', '简立行', '温以宁', '欧阳晨曦',
  '费长青', '温子昂', '杨云舒', '赵明玥', '刘若飞', '苏晚晴', '苏念安',
]
