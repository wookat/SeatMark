...
export const vsPages: VsPage[] = [
  {
    ...
    intro:
      '创客贴是国民级在线设计平台，桌牌台签模板设计质感高，设计完成后可直接在站内下单印刷；SeatMark 则专注「名单 → 批量标签」的打印场景。如果你要为整份名单批量出桌牌并自行打印，两者的差异集中在批量能力与打印精度上。',
    competitorStrengths: [
      '桌牌台签品类模板数十款，整体设计质感高',
      '支持在线印刷下单，设计稿可直接印成成品寄到手（SeatMark 不提供）',
    ...
    faqs: [
      {
        q: '什么情况下更适合用创客贴？',
        a: '只做一两张对设计感要求高的桌牌、或希望设计完直接在线下单印刷时，创客贴更合适：选模板 → 在线编辑 → 直接下单印刷，不用自己打印。',
      },
      {
