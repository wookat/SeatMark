...
export const round4Templates: LabelTemplate[] = [
  ...
  },
  {
    ...
    name: '早餐券位卡',
    category: 'life',
    description: '2 列 × 6 行小券式排版，房号、姓名与用餐日期各占一行，底部一条「凭卡用餐」提示。团队入住时随房卡一起发放。',
    scenario: '酒店早餐 / 团餐券位',
    accent: '#b45309',
  ...
  // ---------- 驾校 ----------
  {
    ...
    name: '驾校学员车贴',
    category: 'life',
    description: '2 列 × 3 行车贴，教练车编号放大居中，教练姓名与学员批次两行居下。贴在车门或后窗，学员在训练场按编号找车。',
    scenario: '驾校教练车 / 训练场',
    accent: '#16a34a',
  ...
  // ---------- 直播间设备 ----------
  {
    ...
    name: '直播间设备标签',
    category: 'life',
    description: '3 列 × 8 行密排小标签，设备名加粗居上，编号与负责人居下。直播间、摄影棚的灯具与机身按编号贴好，借还有据可查。',
    scenario: '直播间 / 摄影棚器材',
    accent: '#4f46e5',
  ...
  // ---------- 绿植认养 ----------
  {
    ...
    name: '绿植认养牌',
    category: 'life',
    description: '2 列 × 5 行，植物名居上，认养人与一句养护提示居下。班级或办公室发起绿植认养时，每盆插一张。',
    scenario: '校园 / 办公室绿植认养',
    accent: '#15803d',
  ...
  // ---------- 研学营队 ----------
  {
    ...
    name: '研学营队牌',
    category: 'teaching',
    description: 'A4 一页 3 枚横牌，营队名大字居上，带队老师与集合口令居下。研学出行集合点举牌分队，学生按营队名归队。',
    scenario: '研学营 / 夏令营分队',
    accent: '#d97706',
  ...
  },
  {
    ...
    name: '棋类比赛台号牌',
    category: 'event',
    description: '2 列 × 4 行台号牌，台号放大居上，红方与黑方姓名左右分列。象棋、围棋赛场每台一张，选手按台号入座。',
  ...
  // ---------- 失物招领 ----------
  {
    ...
    name: '失物招领架标签',
    category: 'life',
    description: '2 列 × 6 行，物品名居上，拾获时间地点与认领编号分行居下。前台失物架每格一张，认领时对编号登记。',
    scenario: '失物招领架 / 前台保管',
    accent: '#475569',
  ...
  // ---------- 样板间标价 ----------
  {
    ...
    name: '样板间标价牌',
    category: 'life',
    description: 'A4 一页 3 枚横牌，商品名居上，价格放大占据主位，规格与材质说明置于底部。家居卖场样板间摆在沙发、床品旁标价。',
    scenario: '家居卖场 / 样板间标价',
    accent: '#0f766e',
    sampleData: {
      product: '云朵三人位布艺沙发',
  ...
  // ---------- 共享工位 ----------
  {
    ...
    name: '共享工位轮用牌',
    category: 'life',
    description: '2 列 × 4 行，工位号居上，当前使用人与预约时段两行居下。灵活办公每天按预约表重打一批，摆在工位隔板上。',
    scenario: '共享办公 / 灵活工位',
    accent: '#2563eb',
