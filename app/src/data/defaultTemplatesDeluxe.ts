...
export const deluxeTemplates: LabelTemplate[] = [
  ...
  },
  {
    ...
    name: '会议桌牌·鎏金雅框',
    category: 'event',
    description: '180×90 mm 桌牌，内外双线鎏金边框配菱形角饰，姓名与单位分层居中。政企年度会议主席台、颁奖典礼嘉宾席都摆得住。',
    scenario: '年度大会 / 颁奖典礼',
    accent: '#a16207',
  ...
  },
  {
    ...
    name: '年会席卡·红绶飘带',
    category: 'event',
    description: '96×62 mm 年会席卡，左上角一条中国红绶带斜披，底部压红金渐变线，姓名与部门居中。年会、答谢宴按桌摆放，喜庆而不俗。',
    scenario: '年会晚宴 / 答谢会',
    accent: '#b91c1c',
  ...
  },
  {
    ...
    name: '婚礼席位卡·拱门月色',
    category: 'wedding',
    description: '90×55 mm 席位卡，杏金拱门线条 + 弦月弧与星点，极简法式浪漫，适合室内婚宴摆台。',
    scenario: '法式婚礼 / 室内婚宴',
    accent: '#b8860b',
  ...
  },
  {
    ...
    name: '婚礼桌号牌·同心双环',
    category: 'wedding',
    description: '96×96 mm 方形桌号牌，A4 一页 4 枚，金色交叠双环象征缔结，桌号放大居中。婚宴厅内隔几桌也能看清桌号。',
    scenario: '婚宴桌号 / 台位牌',
    accent: '#a16207',
  ...
  },
  {
    ...
    name: '班级门牌·黑板报风',
    category: 'teaching',
    description: '190×88 mm 班级门牌，墨绿黑板底配粉笔手绘边框与星星点缀，班级名用粉笔白大字。挂在教室门口，与黑板报风格呼应。',
    scenario: '教室门牌 / 班级标识',
    accent: '#14532d',
