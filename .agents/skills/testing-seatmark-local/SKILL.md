...
- In the 390px template designer, the slide-in properties panel covers the top-right 保存 button — collapse the panel first (top-left collapse arrow) before saving.
